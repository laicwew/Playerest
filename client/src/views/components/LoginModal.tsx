...
import { userSignIn, userSignUp, userSignUpVerify, sendVerifyCode } from "../../helpers/hooks/api/api";
...
export function LoginModal({ show, handleClose, handleLogin }: loginProps) {
  ...
  const handleVerification = async () => {
    try {
      const response = await userSignUpVerify(formik.values.username, verificationCode);
      if (response?.ok) {
